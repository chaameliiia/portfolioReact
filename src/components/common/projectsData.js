...
const projectsData = {
  whatToWear: {
    id: 1,
    title: 'What To Wear',
    mockUp: require('../../assets/imgs/detail/mockup/img_mockup1.png'),
    ...
    projectUrl: '/',
    preview: [
      require('../../assets/imgs/detail/prj1/img_page1.jpg'),
      require('../../assets/imgs/detail/prj1/img_page2.jpg'),
      require('../../assets/imgs/detail/prj1/img_page3.jpg'),
    ],
  },
  wooFooClone: {
    id: 3,
    title: 'WooFoo (clone)',
    mockUp: require('../../assets/imgs/detail/mockup/img_mockup2.png'),
    ...
    preview: [
      require('../../assets/imgs/detail/prj2/img_page1.jpg'),
      require('../../assets/imgs/detail/prj2/img_page2.jpg'),
      require('../../assets/imgs/detail/prj2/img_page3.jpg'),
    ],
  },
  calcForTheWeb: {
    id: 4,
    title: 'Calculator for the Web',
    mockUp: require('../../assets/imgs/detail/mockup/img_mockup3.png'),
    intro:
    ...
    projectUrl: '/',
    preview: [
      require('../../assets/imgs/detail/prj3/img_page1.jpg'),
      require('../../assets/imgs/detail/prj3/img_page2.gif'),
    ],
  },
};
